...
The analysis covers 25+ marketing campaigns and 120+ SKUs across multiple markets.
Key KPIs

Revenue — total and by campaign, market, and SKU
Profit — gross profit and margin
...
Reallocate budget from campaigns with ROI < 1 toward the top 30–35% revenue drivers.
...
Visual polish — layout and formatting will be refined in a future iteration.
Data scope — analysis is based on a fixed dataset; live refresh is not yet configured.
Validation — KPI logic has been spot-checked but not peer-reviewed.

Planned improvements

Add drill-through pages for campaign-level detail.
Build a forecast view for projected ROI under different budget-allocation scenarios.
Standardize formatting (color palette, font hierarchy, conditional formatting on KPI cards).

Feedback is welcome — feel free to open an issue or reach out directly.
How to Open
